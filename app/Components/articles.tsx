  ...
  return (
    <Container className="">
      <section className="relative overflow-hidden bg-orange-500 text-white grid place-items-center rounded-2xl p-20 min-h-[30rem]">
        ...
        <article className="absolute top-0 left-0 w-full h-full z-10 flex flex-col gap-10 items-center justify-center">
          ...
          <Link to="https://israeljuri.hashnode.dev" target='_blank'>
            <button className="text-orange-200 hover:text-orange-100 transition-all duration-300 border-b border-orange-100 sm:border-transparent hover:border-orange-100 py-3 px-2 text-md flex items-center gap-2">
              Read my articles
              <ExternalLink />
            </button>
          </Link>
